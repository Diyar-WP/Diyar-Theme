...
function arabfund_string_translation()
{
    ...
    if (function_exists('pll_register_string')) {
        pll_register_string('readmore', 'Read More', 'diyar_theme', false);
        pll_register_string('download', 'Download', 'diyar_theme', false);
        pll_register_string('view-previous-issues', 'View Previous Issues', 'diyar_theme', false);
        pll_register_string('reset', 'Reset', 'diyar_theme', false);
        pll_register_string('filter', 'Filter', 'diyar_theme', false);
        pll_register_string('to-date', 'To Date', 'diyar_theme', false);
        pll_register_string('from-date', 'From Date', 'diyar_theme', false);
        pll_register_string('searck-keyword', 'Search with a keyword here', 'diyar_theme', false);
        pll_register_string('keyword', 'Keyword', 'diyar_theme', false);
        pll_register_string('view-details', 'View Details', 'diyar_theme', false);
        pll_register_string('photo-title', 'There is a lot going on throughout the year at arabfund. Here is Photo Gallery.', 'diyar_theme', false);
        pll_register_string('video-title', 'There is a lot going on throughout the year at arabfund. Here is Video Gallery.', 'diyar_theme', false);
        pll_register_string('sort-by', 'Sort by', 'diyar_theme', false);
        pll_register_string('publish-date', 'Publish Date', 'diyar_theme', false);

        pll_register_string('title', 'Title', 'diyar_theme', false);
        pll_register_string('attachment', 'Attachment', 'diyar_theme', false);

        pll_register_string('January', 'January', 'diyar_theme', false);
        pll_register_string('February', 'February', 'diyar_theme', false);
        pll_register_string('March', 'March', 'diyar_theme', false);
        pll_register_string('April', 'April', 'diyar_theme', false);
        pll_register_string('May', 'May', 'diyar_theme', false);
        pll_register_string('June', 'June', 'diyar_theme', false);
        pll_register_string('July', 'July', 'diyar_theme', false);
        pll_register_string('August', 'August', 'diyar_theme', false);
        pll_register_string('September', 'September', 'diyar_theme', false);
        pll_register_string('October', 'October', 'diyar_theme', false);
        pll_register_string('November', 'November', 'diyar_theme', false);
        pll_register_string('December', 'December', 'diyar_theme', false);
        pll_register_string('News', 'News', 'diyar_theme', false);
        pll_register_string('Event', 'Event', 'diyar_theme', false);
        pll_register_string('Activity', 'Activity', 'diyar_theme', false);
        pll_register_string('Current Events', 'Current Events', 'diyar_theme', false);
        pll_register_string('Canceled Events', 'Canceled Events', 'diyar_theme', false);
        pll_register_string('Upcoming Events', 'Upcoming Events', 'diyar_theme', false);
        pll_register_string('Past event', 'Past event', 'diyar_theme', false);
        pll_register_string('Monday', 'Monday', 'diyar_theme', false);
        pll_register_string('Tuesday', 'Tuesday', 'diyar_theme', false);
        pll_register_string('Wednesday', 'Wednesday', 'diyar_theme', false);
        pll_register_string('Thursday ', 'Thursday', 'diyar_theme', false);
        pll_register_string('Friday ', 'Friday', 'diyar_theme', false);
        pll_register_string('Saturday ', 'Saturday', 'diyar_theme', false);
        pll_register_string('Sunday', 'Sunday', 'diyar_theme', false);
        pll_register_string('AM ', 'AM', 'diyar_theme', false);
        pll_register_string('PM', 'PM', 'diyar_theme', false);
        pll_register_string('Select', 'Select', 'diyar_theme', false);
        pll_register_string('submit-btn', 'Submit', 'diyar_theme', false);
        pll_register_string('am', 'AM', 'diyar_theme', false);
        pll_register_string('search-query-title', 'Search results for:', 'diyar_theme', false);
        pll_register_string('country-detail', 'Country Details', 'diyar_theme', false);
        pll_register_string('search-no-results', "It seems we can't find what you're looking for.", 'diyar_theme', false);
        pll_register_string('Approved Loans', 'Approved Loans', 'diyar_theme', false);
        pll_register_string('Approved Grants', 'Approved Grants', 'diyar_theme', false);
        pll_register_string('Signed Loans', 'Signed Loans', 'diyar_theme', false);
...
function arabfund_post_pagination($query)
{
    $pagination = paginate_links(array(
        ...
        'mid_size' => 1,
        'prev_next' => false,
        'prev_text' => sprintf('<i></i> %1$s', __('Newer Posts', 'diyar_theme')),
        'next_text' => sprintf('%1$s <i></i>', __('Older Posts', 'diyar_theme')),
        'add_args' => false,
        'add_fragment' => '',
    ));
    return $pagination;
...
function albums_arabfund()
{
    ...
    if ($query->have_posts()):
        ...
        while ($query->have_posts()):
            ...
            if ($mediaimg == "") {
                $mediaimg = "/arabfund/wp-content/themes/diyar_theme/assets/images/no_img_gallery.jpg";
            }
...
function arabfund_newsevent_home()
{
    ...
    while ($query->have_posts()):
        ...
        if ($eventnewsimg == "") {
            $eventnewsimg = "/arabfund/wp-content/themes/diyar_theme/assets/images/noimg_logo.jpg";
        }
        $post_id = get_the_ID();
...
function annual_report_list()
{
    ...
    if ($query->have_posts()):
        while ($query->have_posts()):
            ...
            if ($annualreportsImg == "") {
                $annualreportsImg = "/arabfund/wp-content/themes/diyar_theme/assets/images/pdficon.jpg";
            }
            $post_id = get_the_ID();
...
function jae_annual_report_list()
{
    ...
    if ($query->have_posts()):
        while ($query->have_posts()):
            ...
            if ($report_eng_img == "") {
                $report_eng_img = "/arabfund/wp-content/themes/diyar_theme/assets/images/pdficon.jpg";
            }
            $post_id = get_the_ID();
...
function board_members_list()
{
    ...
    while ($query->have_posts()):
        ...
        $memberimg = get_the_post_thumbnail_url(get_the_ID(), 'full');
        if ($memberimg == "") {
            $memberimg = "/arabfund/wp-content/themes/diyar_theme/assets/images/noimg_team_logo.png";
        }
        $post_id = get_the_ID();
    ...
    while ($query->have_posts()):
        ...
        if ($governorimg == "") {
            $governorimg = "/arabfund/wp-content/themes/diyar_theme/assets/images/noimg_team_logo.png";
        }
        $post_id = get_the_ID();
...
function links_list()
{
    ...
    while ($query->have_posts()):
        ...
        if ($links_img == "") {
            $links_img = "/arabfund/wp-content/themes/diyar_theme/assets/images/no_logo.png";
        }
        $post_id = get_the_ID();
...
function institutions_list()
{
    ...
    while ($query->have_posts()):
        ...
        if ($institutions_img == "") {
            $institutions_img = "/arabfund/wp-content/themes/diyar_theme/assets/images/pdf.svg";
        }
        $post_id = get_the_ID();
...
function newsact_arabfund()
{
    ...
    $eventnewsimg = get_the_post_thumbnail_url(get_the_ID(), 'full');
    if ($eventnewsimg == "") {
        $eventnewsimg = "/arabfund/wp-content/themes/diyar_theme/assets/images/noimg.png";
    }
    $post_id = get_the_ID();
    $categories = get_the_terms($post_id, 'news_or_activity_type');
    $arabdate = get_field('newsevent_date');
    ...
    if ($query->have_posts()):
        while ($query->have_posts()):
            ...
            if ($jae_annualreportsImg == "") {
                $jae_annualreportsImg = "/arabfund/wp-content/themes/diyar_theme/assets/images/pdf.svg";
            }
            $post_id = get_the_ID();
...
function conferences_or_event_detail()
{
    ...
    if ($detailcoverImg == "") {
        $detailcoverImg = "/arabfund/wp-content/themes/diyar_theme/assets/images/cover.jpg";
    }
    $post_id = get_the_ID();
    $categories = get_the_terms($post_id, 'conferences_events_type');
    $event_publish_date = get_field('published_date');
                ...
                while (have_rows('sessions_list_here', $post_id)):
                    ...
                    if (have_rows('session_schedules', $post_id)):
                        ...
                        while (have_rows('session_schedules', $post_id)):
                            ...
                            if ($speakerImg == "") {
                                $speakerImg = "/arabfund/wp-content/themes/diyar_theme/assets/images/user.png";
                            }
